"""End-to-end micromorphic homogenization on the square (box) RVE.

Pipeline:
  1. extract_buckling_modes — find the enrichment modes φ from full-order RVE
     buckling (equal-biaxial compression, "lba" strategy: approach the
     bifurcation, then a linear buckling analysis there).
...
logger = logging.getLogger("fe2_rom.mm.example_1")
