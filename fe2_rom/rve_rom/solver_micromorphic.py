...
Subclass of :class:`RVESolver` that extends the kinematic ansatz with a finite
...
from .solver import RVESolver, _dF_Fbar_factory
...
class MicromorphicRVESolver(RVESolver):
